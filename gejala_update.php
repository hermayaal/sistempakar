...
if (isset($_POST['save'])) {
    ...
    if (empty($error)) {
        ...
        if ($action == 'edit') {
            $q = mysqli_query($con, "select * from gejala where kode_gejala='" . $id . "'");
            ...
            if (mysqli_num_rows(mysqli_query($con, "select * from gejala where kode_gejala='" . $kode_gejala . "' and kode_gejala<>'" . $kode_gejala_tmp . "'")) > 0) {
                ...
                $q = "update gejala set kode_gejala='" . $kode_gejala . "',nama_gejala='" . $nama_gejala . "' where kode_gejala='" . $id . "'";
                mysqli_query($con, $q);
                exit("<script>location.href='" . $link_data . "';</script>");
            }
        }
    ...
    if ($action == 'delete') {
        $id = $_GET['id'];
        mysqli_query($con, "delete from gejala where kode_gejala='" . $id . "'");
        exit("<script>location.href='" . $link_data . "';</script>");
    }
}
?>
